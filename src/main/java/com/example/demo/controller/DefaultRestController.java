...
public class DefaultRestController {
    @GetMapping("/index")//이 안에 주소도 unique해야함
    ...
    @GetMapping("/listTest")//이 안에 주소도 unique해야함
